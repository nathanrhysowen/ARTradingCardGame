...
public class DiceRoller : MonoBehaviour
{
    ...
    private Vector3 originalScale = new Vector3(0.01007413f, 0.01007413f, 0.01007413f); // Set the visible scale for when dice is active
    private int result; // This will store the roll result
    ...
    public void RollDice()
    {
        ...
        StartCoroutine(StopRollingAfterDuration());
    }

    private IEnumerator StopRollingAfterDuration()
    {
